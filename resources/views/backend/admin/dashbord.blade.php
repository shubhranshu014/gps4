    ...
    <div class="container-fluid py-3">
            ...
            <div class="col-md-4 animate__animated animate__fadeInUp animate__faster animate-delay-1">
                <div class="stat-card card h-100">
                    <div class="card-body p-4">
                        ...
                        <h5 class="stat-label">System WLP/Reseller</h5>
                        <h2 class="stat-value" style="color: var(--primary)">{{$wlp}}</h2>
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="badge bg-primary bg-opacity-10 text-primary">+ {{ $wlpCountThisWeek }} this
                                week</span>
            ...
            <div class="col-md-4 animate__animated animate__fadeInUp animate__faster animate-delay-3">
                <div class="stat-card card h-100">
                    <div class="card-body p-4">
                        ...
                        <h2 class="stat-value" style="color: var(--warning)">{{$element}}</h2>
                        <div class="d-flex justify-content-between align-items-center">
                            {{-- <span class="badge bg-warning bg-opacity-10 text-warning">3 needs attention</span> --}}
                            <a href="{{ route('admin.assignedElement', $id = auth('admin')->user()->id) }}"
                                class="stat-link">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header text-white">
                <strong>Recent Activity (WLP & WLP Elements)</strong>
            </div>
                    ...
                    <table class="table table-striped table-hover align-middle mb-0">
                        ...
                        <tbody>
                            @forelse ($recentActivities as $activity)
                                <tr>
                                    <td>
                                        @if($activity->type === 'wlp')
                                            <span class="badge bg-primary">WLP</span>
                                    ...
                                    <td>
                                        @if($activity->type === 'wlp')
                                            <strong>{{ $activity->title ?? 'WLP Created!' }}</strong>
                                        @elseif($activity->type === 'wlpelement')
